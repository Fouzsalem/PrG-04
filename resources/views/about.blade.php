            ...
            <!--=============== NAV MENU ===============-->
                 <div class="nav__menu" id="nav-menu">
                     <ul class="nav__list">
                        ...
                        <li><a href="#" class="nav__link">من نحن</a></li>
         
                        <li><a href="#" class="nav__link">خدماتنا</a></li>
                        
                        <li><a href="#" class="nav__link">عملائنا</a></li>
     ...
     <div class="container co">
          <div class="about-right">
            <div class="about-text">
             <h3>من نحن</h3>
            <h1>شريكك التقني الأمثل</h1>
             <p>
               يمانًا منا بأهمية البرمجة و العالم الرقمي في حياتنا كنا نحن بانوراما القصيم، من الرواد في هذه المجالاتي التي تسعى للارتقاء بمجال التصميم والبرمجة لتكون من كبرى الصروح بالمملكة والشرق الأوسط في تصميم وبرمجة المواقع وتطبيقات الجوال والبرامج الإدارية والمحاسبية .
